'use client'
import category01 from '@/assets/img/home/real-estate/categories/01.png'
import category02 from '@/assets/img/home/real-estate/categories/02.png'
import category03 from '@/assets/img/home/real-estate/categories/03.png'
...
const actionCards: ActionCardType[] = [
  {
    svg: (
      <svg className="text-dark-emphasis mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" width={48} height={48} fill="currentColor">
    ...
    btnText: 'Find a home',
    image: category01,
    btnColor: 'bg-primary/10',
  },
  {
    svg: (
      <svg className="text-white mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" width={48} height={48} fill="currentColor">
...
const ActionCard = () => {
  return (
    <>
      <section className="lg:py-18 py-0">
        <div className="container">
          ...
          >
            {actionCards.map((item, idx) => (
              <SwiperSlide key={idx}>
                <div className={clsx('rounded-md group overflow-hidden', item.btnColor)}>
                  <div className="pt-12 py-6 pb-4">
                    {item.svg}
                    <h3 className={clsx('text-xl font-semibold text-center', item.isActionCard ? 'text-white' : 'text-default-900')}>{item.title}</h3>
                  </div>
                  <div className="flex-col flex items-center gap-12">
                    <Link href="/listings/real-estate" className="mx-6 py-2.5 px-5 text-sm font-medium rounded-md bg-default-800 dark:bg-white text-body-bg hover:bg-black transition-all duration-300">
                      {item.btnText}
                    </Link>
                    <div>
                      <Image src={item.image} alt="Image" className="group-hover:scale-105 transition-all duration-300" />
                    </div>
                  </div>
                </div>
              </SwiperSlide>
