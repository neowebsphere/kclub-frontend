        ...
        <div className="container">
          <div className="lg:w-md md:w-50 w-full lg:py-12">
            ...
            <div className="flex gap-4 flex-wrap items-center">
              <Link href="/listings/contractor-location" className="py-3.5 px-6 rounded-md text-white bg-primary transition-all duration-300 hover:bg-primary-hover lg:w-auto w-full flex justify-center items-center gap-2">
