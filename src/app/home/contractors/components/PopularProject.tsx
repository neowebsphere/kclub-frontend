              ...
              <div className="grid md:grid-cols-2 grid-cols-1 gap-7">
                {projectsData.map((item, idx) => (
                  <div className="group" key={idx}>
                    <Link href="/listings/contractors" className="group"></Link>
                    <div className="flex gap-4">
                      <Link href="/listings/contractors" className="group">
                      ...
                      <div className="pt-1">
                        ...
                        <h3 className="mb-1 font-semibold text-default-900">
                          <Link href="/listings/contractors" className="group"></Link>
                          <Link className="hover:underline transition-all duration-300 ease-in-out" href="/listings/contractors">
                            {item.title}
                          </Link>
                        </h3>
