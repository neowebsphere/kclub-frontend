...
import { ChevronRight, CirclePlus, DollarSign, Trash2 } from 'lucide-react'
        ...
        <div className="container">
          <div className="grid lg:grid-cols-12 grid-cols-1 gap-6 lg:pb-12 md:pb-6 pb-2 lg:pt-4 md:pt-2">
            <div className="lg:col-span-7 col-span-1">
              ...
              <label className="block mb-2 text-default-900 font-semibold text-sm">Describe your work for the project *</label>
              <textarea rows={6} placeholder="Tell potential customers about yourself and your business" required className="w-full rounded-lg border border-default-300 dark:border-white/20 bg-transparent px-4.5 py-2.75" />
              <label className="block text-sm text-default-900 font-semibold mb-2">Approximate Price *</label>
              ...
              <div className="mt-4 pt-4">
                <h2 className="text-default-900 font-semibold mb-2">Add photos and videos</h2>
                ...
                <div className="w-full group">
                  <div className="flex items-center justify-center relative h-full cursor-pointer bg-default-100 dark:bg-white/3 border border-dashed border-default-300 dark:border-white/20 rounded-md p-4">
                    <div className="text-center">
                      <CirclePlus className="text-default-900 mb-2 block size-6 mx-auto" />
              ...
              <div className="pt-12 flex gap-4 items-center">
                <Link href="" className="py-3.5 px-6 inline-flex justify-center items-center rounded-md text-body-bg bg-primary transition-all duration-300 hover:bg-primary-hover font-semibold">
                  Save project and become a pro
                  <ChevronRight className="size-4.5 ms-1" />
                </Link>
                <Link href="" className="text-default-900 font-semibold hover:underline py-2 px-5">
                  Add project later
                </Link>
              </div>
            </div>
