      ...
      <div className="container">
        <div className="lg:py-12 py-6 grid md:grid-cols-12 grid-cols-1 gap-6">
          <div className="lg:col-span-3 md:col-span-4 col-span-1 lg:pe-0 md:pe-6">
            ...
            <p className="mb-4 pb-4 text-default-700">Still have unanswered questions and need to get in touch?</p>
            <Link href="/contact" className="bg-primary text-white py-3.5 px-6 rounded-md font-semibold inline-flex transition-all duration-300 ease-in-out hover:bg-primary-hover">
              Contact us
            </Link>
          </div>
          ...
          <div className="lg:col-span-9 md:col-span-8 col-span-1">
            <div className="lg:w-[850px] w-full ms-auto">
              <div className="hs-accordion-group">
                {faqData.map((faq) => (
                  <div key={faq.id} className="hs-accordion border-b border-default-300 dark:border-white/20" id={`faq-heading-${faq.id}`}>
                    ...
                    <div id={`faq-collapse-${faq.id}`} className="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300" role="region" aria-labelledby={`faq-heading-${faq.id}`}>
                      <div className="pb-5">
                        <p className="text-sm text-default-700 leading-6">{faq.answer}</p>
                      </div>
                    </div>
                  </div>
                ))}
