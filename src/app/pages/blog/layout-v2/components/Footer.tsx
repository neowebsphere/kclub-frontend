  ...
  return (
    <footer className="bg-body-bg dark md:pt-6">
      <div className="container">
        <div className="grid md:grid-cols-4 grid-cols-2 gap-6 pt-12 pb-8 border-b border-default-300 dark:border-white/20">
          {features.map((feature, index) => (
            <div key={index} className="flex gap-2">
              <Icon icon={feature.icon} className="size-6 text-white/80 shrink-0" />
            ...
            <div key={index} className={`${index === 0 ? 'lg:col-span-1 md:col-span-3' : 'lg:col-span-1 md:col-span-2'} col-span-1`}>
                ...
                <div className="pt-2">
                  <ul className="flex flex-col gap-2">
                    {section.links.map((link, linkIndex) => (
                      <li key={linkIndex} className="pt-1">
              ...
              <div className="hs-accordion-group md:hidden block">
                <div className="hs-accordion border-b border-white/20 py-3">
                  <button className="hs-accordion-toggle inline-flex w-full items-center gap-x-3 text-start text-base font-semibold text-white" aria-expanded="false">
                    {section.title}
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 lg:py-6 pt-4 pb-6 md:justify-between">
          ...
          <div className="flex md:order-2 order-1">
            {socialLinks.map((social, index) => (
              <div key={index} className="group hs-tooltip [--placement:auto] flex flex-col items-center justify-center">
