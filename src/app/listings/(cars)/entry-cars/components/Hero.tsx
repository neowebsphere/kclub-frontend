  ...
  return (
    <>
      <div className="flex justify-between items-center mb-6">
        <h1 className="mb-0 lg:text-4.5xl md:text-3.5xl text-2.5xl font-semibold text-default-900">
          Mercedes-Benz A205 Cabriolet&nbsp;&nbsp;
          <span className="text-xl font-normal text-default-500 align-middle">(2021)</span>
        </h1>
        <div className="flex gap-2">
          <div className="group flex justify-center items-center flex-col">
            <div className="hs-dropdown relative inline-flex hs-tooltip [--placement:auto]">
              ...
              <div className="hs-dropdown-menu hidden transition-[opacity,margin] duration opacity-0 hs-dropdown-open:opacity-100 absolute top-10! z-20 min-w-38 border border-border bg-body-bg shadow-custom rounded-md mt-2">
          ...
          <div className="group flex justify-center items-center flex-col hs-tooltip [--placement:auto]">
            <button type="button" className="hs-tooltip-toggle size-10 bg-default-100 dark:bg-white/3 rounded-full inline-flex justify-center items-center gap-2 ">
              ...
              <span className="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible bg-default-800 text-body-bg rounded inline-block absolute invisible text-xs -mt-6 -ms-3 z-10 py-1 px-2 " role="tooltip">
                Wishlist
              </span>
            </button>
          </div>
