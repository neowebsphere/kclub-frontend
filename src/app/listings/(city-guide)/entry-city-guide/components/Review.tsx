    ...
    <>
      <div className="md:col-span-7 col-span-1">
        <div className="flex items-center justify-between mb-6">
          <h2 className="lg:text-2xl md:text-xl text-xl text-default-900 font-semibold">Reviews</h2>
          <div className="flex items-center text-xl text-default-900 font-semibold">
            <Star className="fill-warning text-warning me-2" />
            4.8
            <span className="text-sm font-normal text-default-500 ms-1">(127)</span>
          </div>
        </div>
        <div className="flex justify-between .items-center mb-4">
          <div className="mb-4 me-4 w-full whitespace-nowrap overflow-x-auto">
            <div className="flex flex-nowrap gap-2 pb-2 mb-1">
              ...
              <div>
                ...
                <label className="cursor-pointer rounded-full font-medium px-5 py-2 inline-flex text-sm border border-default-300 peer-checked:bg-default-100 peer-checked:dark:bg-white/3 peer-checked:text-default-800 peer-checked:border-default-900 peer-checked:dark:border-white hover:border-default-900">
                  Only positive (123)
                </label>
              </div>
              <div>
          ...
          <div className="mb-4">
            <button className="border border-primary text-nowrap text-primary hover:text-white text-sm px-4 py-2 rounded-full font-semibold inline-flex items-center justify-center hover:bg-primary transition-all duration-300">
