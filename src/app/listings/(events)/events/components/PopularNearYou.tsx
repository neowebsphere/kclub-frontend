import events15 from '@/assets/img/listings/events/15.jpg'
import events16 from '@/assets/img/listings/events/16.jpg'
import events17 from '@/assets/img/listings/events/17.jpg'
    ...
    <>
      <section className="lg:py-12 md:py-8 pb-8 my-4">
        <div className="container">
          <div className="flex items-center justify-between gap-4 text-nowrap mb-8 md:flex-nowrap flex-wrap">
            <div className="flex items-center md:gap-12 gap-4 md:flex-nowrap flex-wrap">
              <h2 className="lg:text-3.5xl md:text-2.5xl text-2xl font-semibold text-default-900">Popular Near You</h2>
              <div className="overflow-x-auto lg:w-full w-85 md:pb-0 pb-4">
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 pb-12 gap-6">
              ...
              <div className="bg-default-100 dark:bg-white/3 rounded-md group lg:block md:flex block justify-between">
                <Link href="/listings/entry-cars" className="group">
                  <div className="lg:order-1 order-2 rounded-md lg:w-full lg:h-full md:h-60.5 md:w-76.5 overflow-hidden relative">
                    <Image src={events15} alt="Image" className="lg:w-full lg:h-full md:h-60.5 md:w-76.5 object-cover transition-transform duration-500 group-hover:scale-110 z-0 rounded-md" />
            ...
            <div>
              <div className="group mb-6">
                <div className="bg-default-100 dark:bg-white/3 rounded-md gap-10 md:flex block justify-between">
                  <div>
                    ...
                    <div className="md:p-6 p-4 pt-0 flex items-center justify-between">
                      <div className="text-info text-xl font-semibold">$32.00</div>
                      <button
                        type="button"
                        className="rounded-md border border-default-900 dark:border-white text-default-900 dark:text-white py-2.5 px-5 text-sm font-semibold inline-flex relative z-2 ms-auto transition-all duration-300 ease-in-out hover:bg-default-900 hover:text-white"
                      >
                  ...
                  <div>
                    <div className="rounded-md md:h-60.5 md:w-76.5 overflow-hidden relative">
                      <Image src={events16} alt="Image" className="md:h-60.5 md:w-76.5 object-cover transition-transform duration-500 group-hover:scale-110 z-0 rounded-md" />
                      <div className="absolute top-0 end-0 z-10 opacity-0 group-hover:opacity-100 transition pt-2 pe-2 mt-2 me-2">
                        <button type="button" className="size-8 bg-white text-dark rounded-full shadow flex items-center justify-center">
                          <Icon icon="lucide:heart" />
                        </button>
              ...
              <div className="group">
                <div className="bg-default-100 dark:bg-white/3 rounded-md gap-10 md:flex block justify-between">
                  <div>
                    <div className="md:p-6 p-4">
                      <ul className="flex flex-wrap items-center gap-1 text-sm mb-3">
                        <li className="flex items-center">
                          <Icon icon="lucide:calendar" className="me-1" />
                          Oct 15
                        </li>
                    ...
                    <div className="md:p-6 p-4 pt-0 flex items-center justify-between">
                      <div className="text-info text-xl font-semibold">$56.00</div>
                      <button
                        type="button"
                        className="rounded-md border border-default-900 dark:border-white text-default-900 dark:text-white py-2.5 px-5 text-sm font-semibold inline-flex relative z-2 ms-auto transition-all duration-300 ease-in-out hover:bg-default-900 hover:text-white"
                      >
                  ...
                  <div>
                    <div className="rounded-md md:h-60.5 md:w-76.5 overflow-hidden relative">
                      <Image src={events17} alt="Image" className="md:h-60.5 md:w-76.5 object-cover transition-transform duration-500 group-hover:scale-110 z-0 rounded-md" />
                      <div className="absolute top-0 end-0 z-10 opacity-0 group-hover:opacity-100 transition pt-2 pe-2 mt-2 me-2">
                        <button type="button" className="size-8 bg-white text-dark rounded-full shadow flex items-center justify-center">
                          <Icon icon="lucide:heart" />
                        </button>
