        ...
        <div className="container">
          <div className="grid lg:grid-cols-12 grid-cols-1 gap-6 lg:pb-12 md:pb-6 pb-2 lg:pt-4 md:pt-2">
            <div className="lg:col-span-7 col-span-1">
              <h1 className="mb-4 md:pb-2 lg:text-2.5xl md:text-2xl text-xl font-semibold text-default-900">Add your profile photo</h1>
              <div className="flex md:items-center">
                <div>
                  <div className="relative group block rounded-full overflow-hidden md:size-39.5 size-21.25">
                    <Image src={avatar} alt="" className="md:size-39.5 size-21.25 bg-cover object-cover" />
                ...
                <div className="md:ps-6 ps-4 w-full md:w-110">
                  <p className="text-sm mb-4">Your profile photo will appear on your profile and directory listing. PNG or JPG no bigger than 1000px wide and tall.</p>
                  <button type="button" className="border border-border py-1.5 px-4 inline-flex justify-center items-center rounded-md text-default-900 text-xs transition-all duration-300 hover:border-default-900 font-medium">
                    <RefreshCcw className="size-3.5 me-2" />
                    Update photo
                  </button>
                </div>
              </div>
              <div className="pt-12">
                <div className="text-sm mb-2">New here?</div>
                <h2 className="text-default-900 font-semibold text-xl mb-2">Request reviews from past clients and colleagues</h2>
                <p className="text-sm mb-6">Professionals with at least 3 reviews are 15 times more likely to be contacted.</p>
                <button type="button" className="text-sm font-medium text-white bg-warning transition-all duration-300 hover:bg-warning rounded-md py-2.5 px-5 flex items-center">
                  <Star className="size-4 me-2" />
                  Request review
                </button>
              </div>
              <div className="pt-12">
                <label htmlFor="website" className="block mb-2 text-default-900 font-semibold text-sm">
                  website you and your business
                </label>
                <textarea id="website" rows={6} placeholder="Tell potential customers about yourself and your business" required className="w-full rounded-lg border border-default-300 dark:border-white/20 bg-transparent px-4.5 py-2.75" defaultValue={''} />
                <label htmlFor="about" className="block mb-2 text-default-900 font-semibold mt-6 text-sm">
                  Have a website?
                </label>
                <div className="relative">
                  <Icon icon="lucide:link" className="absolute start-4 top-1/2 -translate-y-1/2 text-default-600 size-4.5" />
                  <input type="url" id="link" placeholder="https://" className="w-full rounded-lg border border-default-300 dark:border-white/20 bg-transparent pe-4.5 py-2.75 ps-10" />
                </div>
              </div>
              <div className="pt-12">
                <Link href="/listings/contractor-price-hours" className="py-3.5 px-6 inline-flex justify-center items-center rounded-md text-body-bg bg-default-800 transition-all duration-300 hover:bg-default-900 font-semibold">
            ...
            <div className="lg:block hidden col-span-5">
              <svg xmlns="http://www.w3.org/2000/svg" width={526} viewBox="0 0 526 526" fill="none">
                <rect x="25.5" y="74.5" width={476} height={377} rx="18.5" stroke="currentColor" strokeWidth={5} className="text-info/20" />
                <path fill="currentColor" d="M28 77h471v30H28z" className="text-info/20" />
                <g fill="currentColor" style={{ color: 'var(--fn-body-bg)' }}>
                  <circle cx="51.5" cy="92.5" r="5.5" className="text-body-bg" />
                  <circle cx="69.5" cy="92.5" r="5.5" className="text-body-bg" />
                  <circle cx="87.5" cy="92.5" r="5.5" className="text-body-bg" />
                </g>
                <g clipPath="url(#A)">
                  <circle className="text-info" cx="104.5" cy="183.5" r={52} stroke="currentColor" />
                  ...
                  <path d="M56.375 306.662l10.668-.178-.356-.929 2.237-.04 6.116-71.757.099-1.225.376-4.409c0-.039 0-.079.02-.118-5.878 2.372-17.892 9.31-22.939 12.79l.119 1.937 3.503 61.675.158 2.254z" fill="currentColor" className="text-info/20" />
                  <g className="text-info" fill="currentColor">
                ...
                <g fill="currentColor" style={{ color: 'var(--fn-info-bg-subtle)' }}>
                  <rect x={188} y={181} width={125} height={8} rx={4} className="text-info/20" />
                  <rect x={188} y={201} width={276} height={8} rx={4} className="text-info/20" />
                  <rect x={52} y={264} width="200.5" height={161} rx={12} className="text-info/20" />
                  <rect x={274} y={264} width="200.5" height={161} rx={12} className="text-info/20" />
                </g>
                <defs>
                  <clipPath id="A">
