            ...
            <div key={listing.id} className="group cursor-pointer rounded-md border border-border md:grid md:grid-cols-4">
              <div className="col-span-1">
                <div className="size-full min-h-43.5 rounded-tl-md rounded-tr-md md:rounded-bl-md md:rounded-tr-none md:pe-2">
                  <Image src={listing.image} className="size-full rounded-tl-md rounded-tr-md object-cover md:rounded-bl-md md:rounded-tr-none" alt={listing.address} />
                </div>
              </div>
              ...
              <div className="col-span-3 p-4 md:px-6 md:py-6 md:ps-4">
                <div className="flex w-full justify-between">
                  <div>
                    <div className="mb-2 inline-flex items-center rounded bg-default-100 px-2 py-0.5 text-xs font-medium text-default-900 dark:bg-white/5 dark:text-white">{listing.type}</div>
                    ...
                    <div className="text-sm font-semibold text-default-900 dark:text-white">{listing.area}</div>
                  </div>
