...
const Footer = () => {
  return (
    <>
      <footer className="pt-12 bg-body-bg dark">
        <div className="container">
          <div className="lg:pt-8 pt-4 lg:pb-4 pb-8">
            <div className="grid lg:grid-cols-4 md:grid-cols-12 pb-8">
              <div className="lg:col-span-1 md:col-span-4 mb-4">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <Link href="" className="hover:underline text-white flex items-center gap-2">
                    <Icon icon="lucide:phone-call" className="size-4.5 " />
                    +1 50 537 53 082
                  </Link>
                </div>
              </div>
              <div className="lg:col-span-1 md:col-span-4 md:block hidden">
                <span className="mb-4 text-white text-xl font-semibold">Quick links</span>
              ...
              <div className="lg:col-span-1 md:col-span-4 md:block hidden">
                <span className="mb-4 text-white text-xl font-semibold">Profile</span>
                <ul className="mt-2 gap-2">
                  <li className="pt-2">
                    <Link href="" className="text-sm text-body-color hover:underline hover:text-white">
                      My account
              ...
              <div className="lg:mx-auto md:mx-0 mx-auto lg:pt-0 pt-8 text-center flex-wrap lg:block md:flex md:justify-between md:items-center gap-6 lg:col-span-1 md:col-span-12">
                <div className="lg:mb-4 md:mb-0 mb-4 text-white text-xl font-semibold">Get exclusive advice</div>
                <button className="w-50 border border-white/20 hover:border-white/70 transition-all duration-300 text-sm rounded-xl inline-flex justify-center py-3.5 px-6 text-white">Sign up</button>
                <div className="lg:mt-8 md:mt-0 mt-6 flex justify-center lg:w-30 lg:mx-auto">
            ...
            <div className="bg-dark rounded-xl md:mt-8 grid grid-cols-12 md:gap-6 mb-2">
